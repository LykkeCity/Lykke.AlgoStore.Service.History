...
namespace Lykke.AlgoStore.Service.History.Client.AutorestClient
{
    ...
    /// <summary>
    /// </summary>
    public partial interface IHistoryAPI : System.IDisposable
    {
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> GetFunctionForPeriodWithHttpMessagesAsync(System.DateTime fromParameter, System.DateTime to, string instanceId = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
