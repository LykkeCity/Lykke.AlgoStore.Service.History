...
namespace Lykke.AlgoStore.Service.History.Client
{
    ...
    public interface IHistoryClient
    {
        ...
        /// Thrown when <paramref name="indicatorName"/> or <paramref name="authToken"/> are null
        /// </exception>
        ...
        /// </exception>
        Task<IEnumerable<Candle>> GetCandles(DateTime from, DateTime to, string indicatorName, string authToken);
    }
}
